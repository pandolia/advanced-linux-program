...
/* Prints usage information for this program to STREAM (typically
   stdout or stderr), and exit the program with EXIT_CODE. Dose not
   return. */
...
int main(int argc, char *argv[]) {
	...
	/* A string listing valid shord options letters. */
	...
	/* Done with options. OPTION points to first nonoption argument.
