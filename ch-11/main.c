/* p11.5-main.c
 * Main Server Program and Command-Line Parsing
 */
#include <assert.h>
#include <getopt.h>
#include <netdb.h>
...
/* Desciption of short options for getopt_long. */
 ...
 * stderr and use and error exit code. Otherwise, write to stdout and
...
int main(int argc, char* const argv[])
{
    ...
    /* This program takes no additional arguments. Issue an error if
     * the user specified any. */
    if (optind != argc) {
        print_usage(1);
    }
